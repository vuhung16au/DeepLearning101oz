...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[x=1.8cm,y=1.8cm]
    ...
    \definecolor{cellA}{RGB}{50,120,200}  % TP
    \definecolor{cellB}{RGB}{200,80,80}   % FP
    \definecolor{cellC}{RGB}{200,80,80}   % FN
    \definecolor{cellD}{RGB}{20,160,60}   % TN
    % Draw borders
    ...
    \node at (-0.25,1.5) {$+$};
    % Counts
    \node[white] at (0.5,1.5) {100};
    \node[white] at (1.5,1.5) {15};
    \node[white] at (0.5,0.5) {10};
    \node[white] at (1.5,0.5) {875};
  \end{tikzpicture}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[gray] coordinates {(0,0) (1,1)};\addlegendentry{Random}
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[gray] coordinates{(0,0) (1,1)};
    \end{axis}
  \end{tikzpicture}
