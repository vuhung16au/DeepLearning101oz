...
\begin{tikzpicture}[scale=0.9]
    ...
    \node[draw, rectangle, fill=purple!15] (s1) at (0,0) {Subnetwork 1};
    \node[draw, rectangle, fill=purple!15] (s2) at (3,0) {Subnetwork 2};
    \node[draw, rectangle, fill=purple!15] (s3) at (6,0) {Subnetwork 3};
    \node[draw, circle, fill=blue!20] (avg) at (3,-1.8) {Average};
    \draw[->] (s1) -- (avg);
    \draw[->] (s2) -- (avg);
    \draw[->] (s3) -- (avg);
\end{tikzpicture}
