...
% Underflow region
\addplot[red, thick, domain=1e-50:1e-38] {0.2};
\node[red] at (axis cs: 1e-45, 0.3) {Underflow};

% Normal range
\addplot[blue, thick, domain=1e-38:1e38] {0.5};
\node[blue] at (axis cs: 1, 0.6) {Normal Range};

% Overflow region
\addplot[red, thick, domain=1e38:1e50] {0.8};
\node[red] at (axis cs: 1e45, 0.9) {Overflow};
\end{axis}
\end{tikzpicture}
