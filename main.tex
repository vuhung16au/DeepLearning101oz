...
\else
  ...
  % CJK fonts (choose commonly available macOS font)
...
% Full-page cover image - stretch to fill entire page edge-to-edge
% Conditionally select cover image based on paper size
\ifdefstring{\papersize}{a4paper}{%
  \noindent\includegraphics[width=\paperwidth,height=\paperheight]{images/DeepLearning101-cover-A4.png}%
}{%
  \ifdefstring{\papersize}{a5paper}{%
    \noindent\includegraphics[width=\paperwidth,height=\paperheight]{images/DeepLearning101-cover-A5.png}%
  }{%
    \ifdefstring{\papersize}{letterpaper}{%
      \noindent\includegraphics[width=\paperwidth,height=\paperheight]{images/DeepLearning101-cover-letter.png}%
    }{%
      \ifdefstring{\papersize}{a6paper}{%
        \noindent\includegraphics[width=\paperwidth,height=\paperheight]{images/DeepLearning101-cover-A6.png}%
      }{%
        \ifdefstring{\papersize}{b5paper}{%
          \noindent\includegraphics[width=\paperwidth,height=\paperheight]{images/DeepLearning101-cover-B5.png}%
        }{%
          \ifdefstring{\papersize}{trade}{%
            \noindent\includegraphics[width=\paperwidth,height=\paperheight]{images/DeepLearning101-cover-trade.png}%
          }{%
            % Default fallback to A5
            \noindent\includegraphics[width=\paperwidth,height=\paperheight]{images/DeepLearning101-cover-A5.png}%
          }%
        }%
      }%
