...
\newcommand{\difficultyBeginner}{💫}
\newcommand{\difficultyIntermediate}{⭐️}
\newcommand{\difficultyAdvanced}{🌟}

% Main difficulty command that appends the appropriate emoji indicator
